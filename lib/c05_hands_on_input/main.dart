...
class HandsOnInputFavorsPage extends StatefulWidget {
  HandsOnInputFavorsPage({
    Key key,
  }) : super(key: key);

  @override
  State<StatefulWidget> createState() => HandsOnInputFavorsPageState();
}

class HandsOnInputFavorsPageState extends State<HandsOnInputFavorsPage> {
  ...
  static HandsOnInputFavorsPageState of(BuildContext context) {
    // return context.ancestorStateOfType(TypeMatcher<HandsOnInputFavorsPageState>());
    return context.findAncestorStateOfType<HandsOnInputFavorsPageState>();
  }
      ...
      return Row(
        ...
        children: <Widget>[
          FlatButton(
            child: Text("Refuse"),
            onPressed: () {
              HandsOnInputFavorsPageState.of(context).refuseToDo(favor);
            },
          ),
          FlatButton(
            child: Text("Do"),
            onPressed: () {
              HandsOnInputFavorsPageState.of(context).acceptToDo(favor);
            },
          )
        ],
      );
      ...
      return Row(
        ...
        children: <Widget>[
          FlatButton(
            child: Text("give up"),
            onPressed: () {
              HandsOnInputFavorsPageState.of(context).giveUp(favor);
            },
          ),
          FlatButton(
            child: Text("complete"),
            onPressed: () {
              HandsOnInputFavorsPageState.of(context).complete(favor);
            },
          )
        ],
      );
