...
class PlatformSwitchWidgets extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    if (Platform.isIOS) {
      return CupertinoApp(
        //theme: lightCupertinoTheme,
        home: HandsOnThemesFavorsPage(),
      );
    }
    return MaterialApp(
      theme: lightTheme,
...
class HandsOnThemesFavorsPage extends StatefulWidget {
  HandsOnThemesFavorsPage({
    Key key,
  }) : super(key: key);

  @override
  State<StatefulWidget> createState() => HandsOnThemesFavorsPageState();
}

class HandsOnThemesFavorsPageState extends State<HandsOnThemesFavorsPage> {
  ...
  static HandsOnThemesFavorsPageState of(BuildContext context) {
    // return context.ancestorStateOfType(TypeMatcher<HandsOnThemesFavorsPageState>());
    return context.findAncestorStateOfType<HandsOnThemesFavorsPageState>();
  }
      ...
      return Row(
        ...
        children: <Widget>[
          FlatButton(
            child: Text("Refuse"),
            onPressed: () {
              HandsOnThemesFavorsPageState.of(context).refuseToDo(favor);
            },
          ),
          FlatButton(
            child: Text("Do"),
            onPressed: () {
              HandsOnThemesFavorsPageState.of(context).acceptToDo(favor);
            },
          )
        ],
      );
      ...
      return Row(
        ...
        children: <Widget>[
          FlatButton(
            child: Text("give up"),
            onPressed: () {
              HandsOnThemesFavorsPageState.of(context).giveUp(favor);
            },
          ),
          FlatButton(
            child: Text("complete"),
            onPressed: () {
              HandsOnThemesFavorsPageState.of(context).complete(favor);
            },
          )
        ],
      );
